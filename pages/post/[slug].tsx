  ...
  return (
    <main>
      ...
      <hr className="max-w-lg my-5 mx-auto border bg-yellow-500" />
       {submitted ? (
        <div className="flex flex-col py-10 my-10 bg-yellow-500 max-w-3xl mx-auto text-black">
        ...
        >
          ...
          <input
            className="shadow bg-yellow-500 hover:bg-yellow-400 text-white
      ...
      <div
        ...
        shadow-yellow-500 rounded-sm shadow space-y-2
          "
      >
